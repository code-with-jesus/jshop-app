...
import com.jcode.jshop.backend.persistence.converters.LocalDateTimeAttributeConverter;
...
public class PasswordResetToken implements Serializable {
	 ...
	 * @param expirationInMinutes The length, in minutes, for which this token will be valid. If zero, it will
	 * 							  be assigned a default value of 120 (2 hours)
